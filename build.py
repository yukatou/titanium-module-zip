...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','TiZipArchive.js')
	...
	f = os.path.join(cwd,'Classes','TiZipArchiveModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','TiZipArchive.js']
